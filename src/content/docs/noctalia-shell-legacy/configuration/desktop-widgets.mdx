...
- **Flip Horizontal / Flip Vertical** - toolbar buttons in edit mode mirror the selected widget(s)
...
See the [Desktop Widget plugin guide](/noctalia-shell-legacy/development/plugins/desktop-widget/) for how to build one.
