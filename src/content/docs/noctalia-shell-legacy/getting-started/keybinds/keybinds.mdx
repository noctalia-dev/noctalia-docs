...
<CardGrid>
  <LinkCard title="Core & Navigation" description="Launcher, Control Center, Settings and basic utilities." href="/noctalia-shell-legacy/getting-started/keybinds/core-and-navigation/" />
  <LinkCard title="System Controls" description="Audio, Media, Connectivity, Display and Power management." href="/noctalia-shell-legacy/getting-started/keybinds/system-controls/" />
  <LinkCard title="Interface & Plugins" description="Notifications, Appearance, Security and Plugin controls." href="/noctalia-shell-legacy/getting-started/keybinds/interface-and-plugins/" />
</CardGrid>
...
<details open>
<summary><strong>Mango Configuration</strong></summary>
