...
For detailed, program-specific setup instructions, see the [Program Specific Theming](/noctalia-shell-legacy/theming/program-specific/gtk-qt/) section. You'll find step-by-step guides for GTK, Qt, Discord, VSCode, Emacs, Firefox, and more.
:::
