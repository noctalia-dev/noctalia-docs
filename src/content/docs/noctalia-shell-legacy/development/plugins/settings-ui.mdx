...
- [Manifest Reference](/noctalia-shell-legacy/development/plugins/manifest/) - Default settings configuration
- [Translations](/noctalia-shell-legacy/development/plugins/translations/) - Translate your settings UI
