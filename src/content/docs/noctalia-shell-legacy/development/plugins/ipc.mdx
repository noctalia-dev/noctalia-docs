...
- [Getting Started](/noctalia-shell-legacy/development/plugins/getting-started/) - Plugin development basics
- [Main Component](/noctalia-shell-legacy/development/plugins/overview/#main-component) - Overview of Main.qml
- [Plugin API Reference](/noctalia-shell-legacy/development/plugins/api/) - Complete API reference
