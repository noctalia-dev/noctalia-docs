...
:::tip[Quick Start]
New to plugin development? Jump straight to the [Getting Started guide](/noctalia-shell-legacy/development/plugins/getting-started/) to create your first plugin in minutes!
:::
...
**Learn more:** [Bar Widget Development](/noctalia-shell-legacy/development/plugins/bar-widget/)
...
**Learn more:** [Desktop Widget Development](/noctalia-shell-legacy/development/plugins/desktop-widget/)
...
**Learn more:** [Control Center Widget Development](/noctalia-shell-legacy/development/plugins/control-center-widget/)
...
**Learn more:** [Launcher Provider Development](/noctalia-shell-legacy/development/plugins/launcher-provider/)
...
**Learn more:** [Panel Development](/noctalia-shell-legacy/development/plugins/panel/)
...
**Learn more:** [IPC Guide](/noctalia-shell-legacy/development/plugins/ipc/)
...
**Learn more:** [Settings UI Guide](/noctalia-shell-legacy/development/plugins/settings-ui/)
...
For complete API documentation, see the [Plugin API Reference](/noctalia-shell-legacy/development/plugins/api/).
:::
...
1. **[Getting Started](/noctalia-shell-legacy/development/plugins/getting-started/)** - Create a basic plugin
  - Set up your development environment
  - Create a basic bar widget
  - Understand the plugin structure

2. **[Manifest Reference](/noctalia-shell-legacy/development/plugins/manifest/)** - Understand plugin configuration
  - Learn all manifest fields
  - Configure entry points
  - Set up default settings

3. **[Bar Widget Development](/noctalia-shell-legacy/development/plugins/bar-widget/)** - Build bar widgets
  - Create interactive widgets
  - Handle user interactions
  - Style with Noctalia's design system

4. **[Desktop Widget Development](/noctalia-shell-legacy/development/plugins/desktop-widget/)** - Create desktop widgets
  - Draggable, scalable widgets
  - At-a-glance information displays

5. **[Control Center Widget](/noctalia-shell-legacy/development/plugins/control-center-widget/)** - Add control center buttons
  - Quick action buttons
  - Panel toggle buttons

6. **[Launcher Provider](/noctalia-shell-legacy/development/plugins/launcher-provider/)** - Extend the launcher
  - Custom search sources
  - Command handlers
  - Category-based browsing

7. **[Panel Development](/noctalia-shell-legacy/development/plugins/panel/)** - Create overlay panels
  - Build full-screen interfaces
  - Handle panel lifecycle
  - Create complex UIs

8. **[Plugin API Reference](/noctalia-shell-legacy/development/plugins/api/)** - Master the API
  - Complete API documentation
  - Service integration
  - Advanced patterns

9. **[IPC Guide](/noctalia-shell-legacy/development/plugins/ipc/)** - Background processing
  - Create IPC handlers
  - Handle external commands
  - Integrate with scripts and keybindings

10. **Additional Topics**
- [Settings UI](/noctalia-shell-legacy/development/plugins/settings-ui/) - Configuration interfaces
- [Translations](/noctalia-shell-legacy/development/plugins/translations/) - Internationalization

## Example Plugins

Explore these example plugins in the [official repository](https://github.com/noctalia-dev/legacy-v4-plugins) to see real-world implementations:
...
Ready to start building? Head to the [Getting Started guide](/noctalia-shell-legacy/development/plugins/getting-started/) to create your first plugin in just a few minutes!
