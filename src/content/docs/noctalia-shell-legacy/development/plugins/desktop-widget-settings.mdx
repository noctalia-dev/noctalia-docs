...
Unlike the general [Settings UI](/noctalia-shell-legacy/development/plugins/settings-ui/) which configures plugin-wide settings.
...
### `pluginApi`
The standard [Plugin API](/noctalia-shell-legacy/development/plugins/api/) object. Use it to access plugin-wide settings, translations, manifest data, and more.
...
## See Also
- [Getting Started](/noctalia-shell-legacy/development/plugins/getting-started/) - Create desktop widgets
- [Bar Widget Development](/noctalia-shell-legacy/development/plugins/bar-widget/) - Create bar widgets
- [Desktop Widget Development](/noctalia-shell-legacy/development/plugins/desktop-widget/) - Create desktop widgets
- [Plugin API](/noctalia-shell-legacy/development/plugins/api/) - Full API reference
- [Manifest Reference](/noctalia-shell-legacy/development/plugins/manifest/) - Create desktop widgets settings
