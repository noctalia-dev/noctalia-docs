...
Common action names for `checkKey` include `"up"`, `"down"`, `"left"`, `"right"`, `"enter"`, and `"escape"`. More keybinds may be available - check [`Settings.qml`](https://github.com/noctalia-dev/noctalia/blob/legacy-v4/Commons/Settings.qml) under `general.keybinds` for the full list.
...
- [Bar Widget](/noctalia-shell-legacy/development/plugins/bar-widget/) - Bar widget development
- [Desktop Widget](/noctalia-shell-legacy/development/plugins/desktop-widget/) - Desktop widget development
- [Control Center Widget](/noctalia-shell-legacy/development/plugins/control-center-widget/) - Control center widget development
- [Launcher Provider](/noctalia-shell-legacy/development/plugins/launcher-provider/) - Launcher provider development
- [Panel](/noctalia-shell-legacy/development/plugins/panel/) - Panel development
- [Settings UI](/noctalia-shell-legacy/development/plugins/settings-ui/) - Settings UI development
- [Translations](/noctalia-shell-legacy/development/plugins/translations/) - i18n guide
- [Manifest Reference](/noctalia-shell-legacy/development/plugins/manifest/) - Plugin configuration
- [Plugin Overview](/noctalia-shell-legacy/development/plugins/overview/) - Plugin system overview
