...
## Step 6: Add Your Widget to the Bar
...
- [Add a Panel](/noctalia-shell-legacy/development/plugins/panel/) - Create an overlay panel
- [Bar Widget Development](/noctalia-shell-legacy/development/plugins/bar-widget/) - Advanced bar widget features
- [Plugin API Reference](/noctalia-shell-legacy/development/plugins/api/) - Complete API documentation
- [Manifest Reference](/noctalia-shell-legacy/development/plugins/manifest/) - Full manifest documentation

- [IPC Guide](/noctalia-shell-legacy/development/plugins/ipc/) - Respond to external commands
- [Settings UI](/noctalia-shell-legacy/development/plugins/settings-ui/) - Let users configure your plugin
- [Translations](/noctalia-shell-legacy/development/plugins/translations/) - Support multiple languages
...
5. **Translations preserve state** - Translation reloads don't reset plugin state
...
- [Manifest Reference](/noctalia-shell-legacy/development/plugins/manifest/) - Complete manifest documentation
- [Bar Widgets](/noctalia-shell-legacy/development/plugins/bar-widget/) - Advanced bar widget features
