...
**Example**: `"https://github.com/noctalia-dev/legacy-v4-plugins"`
...
See [IPC Guide](/noctalia-shell-legacy/development/plugins/ipc/) for details.
...
See [Bar Widget Guide](/noctalia-shell-legacy/development/plugins/bar-widget/) for details.
...
See [Desktop Widget Guide](/noctalia-shell-legacy/development/plugins/desktop-widget/) for details.
...
See [Desktop Widget Guide](/noctalia-shell-legacy/development/plugins/desktop-widget-settings/) for details.
...
See [Control Center Widget Guide](/noctalia-shell-legacy/development/plugins/control-center-widget/) for details.
...
:::tip
When providing a launcher provider, set `commandPrefix` in `metadata` to define the `>prefix` command. This is also used by `pluginApi.toggleLauncher()` for IPC integration. See [IPC Guide](/noctalia-shell-legacy/development/plugins/ipc/#launcher-provider-ipc) for details.
:::

See [Launcher Provider Guide](/noctalia-shell-legacy/development/plugins/launcher-provider/) for details.
...
See [Panel Guide](/noctalia-shell-legacy/development/plugins/panel/) for details.
...
- **Type**: String
- **Default**: Plugin ID
- **Description**: The command prefix used to activate this plugin's launcher provider
- **Purpose**:
 - Defines the `>prefix` command that activates your launcher provider
 - Used by `pluginApi.toggleLauncher()` to pre-fill the search text
 - Falls back to the plugin ID if not specified

**Usage**:
```json
{
  "metadata": {
    "commandPrefix": "kaomoji"
  }
}
```

With the above, the launcher command would be `>kaomoji` and `pluginApi.toggleLauncher()` would open the launcher with `>kaomoji ` pre-filled.

:::tip
Set `commandPrefix` when your desired command is shorter or different from your plugin ID. For example, the `calibre-provider` plugin uses `"commandPrefix": "cb"` so users type `>cb` instead of `>calibre-provider`.
:::
...
- [Getting Started](/noctalia-shell-legacy/development/plugins/getting-started/) - Create your first plugin
- [Bar Widget Guide](/noctalia-shell-legacy/development/plugins/bar-widget/) - Develop bar widgets
- [Desktop Widget Guide](/noctalia-shell-legacy/development/plugins/desktop-widget/) - Create desktop widgets
- [Desktop Widget Settings Guide](/noctalia-shell-legacy/development/plugins/desktop-widget-settings/) - Create desktop widgets settings
- [Control Center Widget Guide](/noctalia-shell-legacy/development/plugins/control-center-widget/) - Add control center buttons
- [Launcher Provider Guide](/noctalia-shell-legacy/development/plugins/launcher-provider/) - Extend the launcher
- [Panel Guide](/noctalia-shell-legacy/development/plugins/panel/) - Create overlay panels
- [Plugin API](/noctalia-shell-legacy/development/plugins/api/) - Full API reference
