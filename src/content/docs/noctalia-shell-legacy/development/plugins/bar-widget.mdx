...
### `sectionWidgetIndex`
The zero-based index of this widget within its bar section. Used to access per-instance settings and to build unique identifiers for service registration.
...
- [Panel Development](/noctalia-shell-legacy/development/plugins/panel/) - Create overlay panels
