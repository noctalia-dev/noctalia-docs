...
| `preferredGridColumns` | `int` | `5` | Number of columns in grid view. This is then scaled based on the density setting. |
...
- [Bar Widget](/noctalia-shell-legacy/development/plugins/bar-widget/) - Widgets for the top/bottom bar
- [Control Center Widget](/noctalia-shell-legacy/development/plugins/control-center-widget/) - Quick action buttons
