...
For a complete guide, see [Desktop Widget Settings](/noctalia-shell-legacy/development/plugins/desktop-widget-settings/).
...
- [Bar Widget Development](/noctalia-shell-legacy/development/plugins/bar-widget/) - Create desktop widgets
