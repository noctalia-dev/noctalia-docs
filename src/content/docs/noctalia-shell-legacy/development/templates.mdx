...
For **users** who want to create custom templates for their own applications, see [User Templates](/noctalia-shell-legacy/theming/user-templates/).
...
For complete template syntax documentation (colors, formats, filters, blocks), see the [User Templates](/noctalia-shell-legacy/theming/user-templates/) guide.
