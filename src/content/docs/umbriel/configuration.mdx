...
The packaged starting file is installed under `share/umbriel/config.toml` and can be copied into your user config directory as a starting point. Umbriel does not create or modify a user config automatically.
