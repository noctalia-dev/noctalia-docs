...
- [Workspaces Overview](/umbriel/workspace-overview/): an overview of all workspaces and hot corners.
...
- [Sandboxed Clients](/umbriel/security/): security-context filtering and its boundary.
...
See [Workspaces Overview](/umbriel/workspace-overview/) for overview and hot corner settings.
