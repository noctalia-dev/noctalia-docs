...
| `workspace_axis`                             | string                            | `"vertical"` | Axis the output's workspaces are arranged along: `"vertical"` or `"horizontal"`. The scrolling strip runs perpendicular to it. See [Workspace axis](/umbriel/workspaces/#workspace-axis). |
...
[Workspaces](/umbriel/workspaces/#choose-a-workspace-model).
...
add new ones. See
[Persistent names in a dynamic inventory](/umbriel/workspaces/#persistent-names-in-a-dynamic-inventory).
...
[Workspace rules](/umbriel/workspaces/#workspace-rules).
...
See [Scrolling behavior](/umbriel/layout/#scrolling-behavior) for window-rule and
...
key. See [window rules](/umbriel/window-rules/#settings-updated-while-a-window-is-open).
...
See [window rules](/umbriel/window-rules/#settings-updated-while-a-window-is-open)
