...
key. See [window rules](/umbriel/rules/#settings-updated-while-a-window-is-open).
...
See [window rules](/umbriel/rules/#settings-updated-while-a-window-is-open) for per-window
overrides.
...
[Actions](/umbriel/actions/) for the full list and their exact semantics.
