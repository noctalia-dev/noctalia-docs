...
key. See [window rules](/umbriel/rules-windows/#settings-updated-while-a-window-is-open).
...
See [window rules](/umbriel/rules-windows/#settings-updated-while-a-window-is-open)
