...
- [Per-output scratchpads](/umbriel/scratchpads/) for temporarily hiding
...
<CardGrid>
  ...
  <LinkCard title="Scratchpads" description="Setup, workflow, and multi-output behavior." href="/umbriel/scratchpads/" />
