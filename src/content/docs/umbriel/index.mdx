...
1. [Install Umbriel](/umbriel/installation/).
2. [Copy and edit the starting configuration](/umbriel/configuration/#starting-configuration).
3. Configure your [outputs](/umbriel/outputs/), [input devices](/umbriel/input/), and
   [keybinds](/umbriel/keybinds/).
4. Choose a [layout](/umbriel/layout/) and [workspace model](/umbriel/workspaces/).
5. Use [window rules](/umbriel/window-rules/) for application-specific behavior.
...
- Floating, pinned, fullscreen, and [scratchpad](/umbriel/scratchpads/) windows
...
- Local [IPC](/umbriel/ipc/) for scripts, panels, and runtime inspection
