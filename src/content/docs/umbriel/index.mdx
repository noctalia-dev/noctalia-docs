...
See [Installation](/umbriel/installation/) for distribution packages, manual build
...
- [Per-output scratchpads](/umbriel/scratchpads/) for temporarily hiding windows, with toggle, move, restore, and focus-next actions
...
- Live-reloaded TOML configuration with diagnostics and includes, plus [local IPC](/umbriel/ipc/) with an event stream and
...
files override earlier ones. See [Configuration](/umbriel/configuration/).
