---
title: Umbriel
description: Umbriel is a Wayland compositor for daily use, with scrolling and tiling layouts, per-output workspaces, window rules, blur, shadows, and fluid animations.
---
