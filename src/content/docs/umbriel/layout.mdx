---
title: Layout
description: Configure Scrolling, Dwindle, and Master layouts, including shared and per-layout settings.
---
...
[Actions](/umbriel/actions/#argument-forms). A workspace rule can set a
persistent per-workspace mode; see [Workspace Rules](/umbriel/workspaces/#workspace-rules).
...
[workspace axis](/umbriel/workspaces/#workspace-axis): an output whose workspaces are
...
Connector and monitor names follow the normal [output identity](/umbriel/outputs/)
