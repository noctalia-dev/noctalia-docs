---
title: Input
description: Configure Umbriel keyboard, pointer, touchpad, tablet, cursor, focus, and device input behavior.
---
...
[Workspaces Overview](/umbriel/workspaces-overview/#settings-and-behavior).
