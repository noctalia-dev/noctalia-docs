...
[`[overview]`](/umbriel/workspaces-overview/#settings-and-behavior).
...
See [Scratchpads](/umbriel/scratchpads/) for how scratchpad windows behave and use the
...
[window rules](/umbriel/window-rules/) or [layer rules](/umbriel/layer-rules/).
...
During a [custom window animation](/umbriel/animation/#custom-glsl-shaders), shadows
