---
title: Appearance
description: Configure colors, window appearance, blur, shadows, borders, and transparency.
---
...
outer border. A [window rule](/umbriel/window-rules/#border-colors) can override any of
...
See [Workspaces Overview](/umbriel/workspaces-overview/#settings-and-behavior) for
overview behavior.
...
[window rule](/umbriel/window-rules/#decoration) can override `border_width` and
...
[window rules](/umbriel/window-rules/) or [layer rules](/umbriel/layer-rules/). Blur appears
...
[custom window animation](/umbriel/animation/#custom-glsl-shaders), the shadow follows
the visible shape produced by the shader. A
[window rule](/umbriel/window-rules/#decoration) can turn the shadow on or off for the
windows it matches.
