---
title: Workspaces
description: Configure dynamic and static workspaces, inspect their state, and apply per-workspace layout rules.
---
...
vertically; see [Scrolling layout](/umbriel/layout/#scrolling-layout). Dwindle and
...
per-output keys documented in [Outputs](/umbriel/outputs/#settings). The workspace
