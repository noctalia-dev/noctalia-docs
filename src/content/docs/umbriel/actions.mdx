...
described in [Layouts](/umbriel/layout/). Where that projection changes what an action
...
their visual directions; see [Vertical strips](/umbriel/layout/#vertical-strips).
