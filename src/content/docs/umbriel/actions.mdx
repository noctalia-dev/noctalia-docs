...
lists every available action. See [Keybinds](/umbriel/keybinds/) for binding syntax and
[IPC](/umbriel/ipc/) for the socket behind `umbriel msg`, including the event stream
...
See [Scratchpads](/umbriel/scratchpads/) for setup examples, the full workflow,
