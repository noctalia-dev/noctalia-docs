...
[overview action](/umbriel/actions/#overview). Opening the overview temporarily hides
...
along the output's [workspace axis](/umbriel/workspaces/#workspace-axis) moves between
