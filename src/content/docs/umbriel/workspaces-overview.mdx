...
description: Configure the workspace overview, navigation, shortcuts, appearance, and window movement.
---
...
or use one of the [overview actions](/umbriel/actions/#overview).
...
- Movement along the output's [workspace axis](/umbriel/workspaces/#workspace-axis)
...
release. See [animation](/umbriel/animation/).
...
[`[colors.overview]`](/umbriel/appearance/#overview-colors).
