...
For **users** who want to create custom templates for their own applications, see [User Templates](/v4/theming/user-templates/).
...
For complete template syntax documentation (colors, formats, filters, blocks), see the [User Templates](/v4/theming/user-templates/) guide.
