...
- [Main Component](/v4/development/plugins/overview/#main-component) - Overview of Main.qml
- [Plugin API Reference](/v4/development/plugins/api/) - Complete API documentation
