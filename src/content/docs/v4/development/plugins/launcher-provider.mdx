...
- [Bar Widget](/v4/development/plugins/bar-widget/) - Widgets for the top/bottom bar
- [Control Center Widget](/v4/development/plugins/control-center-widget/) - Quick action buttons
