...
- [Add a Panel](/v4/development/plugins/panel/) - Create an overlay panel
- [Bar Widget Development](/v4/development/plugins/bar-widget/) - Advanced bar widget features
- [Plugin API Reference](/v4/development/plugins/api/) - Complete API documentation
- [Manifest Reference](/v4/development/plugins/manifest/) - Full manifest documentation

- [IPC Guide](/v4/development/plugins/ipc/) - Respond to external commands
- [Settings UI](/v4/development/plugins/settings-ui/) - Let users configure your plugin
- [Translations](/v4/development/plugins/translations/) - Support multiple languages
...
- [Manifest Reference](/v4/development/plugins/manifest/) - Complete manifest documentation
- [Bar Widgets](/v4/development/plugins/bar-widget/) - Advanced bar widget features
