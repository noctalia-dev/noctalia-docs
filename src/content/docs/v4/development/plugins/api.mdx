...
Common action names for `checkKey` include `"up"`, `"down"`, `"left"`, `"right"`, `"enter"`, and `"escape"`. More keybinds may be available - check [`Settings.qml`](https://github.com/noctalia-dev/noctalia-shell/blob/main/Commons/Settings.qml) under `general.keybinds` for the full list.
...
- [Bar Widget](/v4/development/plugins/bar-widget/) - Bar widget development
- [Desktop Widget](/v4/development/plugins/desktop-widget/) - Desktop widget development
- [Control Center Widget](/v4/development/plugins/control-center-widget/) - Control center widget development
- [Launcher Provider](/v4/development/plugins/launcher-provider/) - Launcher provider development
- [Panel](/v4/development/plugins/panel/) - Panel development
- [Settings UI](/v4/development/plugins/settings-ui/) - Settings UI development
- [Translations](/v4/development/plugins/translations/) - i18n guide
- [Manifest Reference](/v4/development/plugins/manifest/) - Plugin configuration
- [Plugin Overview](/v4/development/plugins/overview/) - Plugin system overview
