...
See [IPC Guide](/v4/development/plugins/ipc/) for details.
...
See [Bar Widget Guide](/v4/development/plugins/bar-widget/) for details.
...
See [Desktop Widget Guide](/v4/development/plugins/desktop-widget/) for details.
...
See [Desktop Widget Guide](/v4/development/plugins/desktop-widget-settings/) for details.
...
See [Control Center Widget Guide](/v4/development/plugins/control-center-widget/) for details.
...
:::tip
When providing a launcher provider, set `commandPrefix` in `metadata` to define the `>prefix` command. This is also used by `pluginApi.toggleLauncher()` for IPC integration. See [IPC Guide](/v4/development/plugins/ipc/#launcher-provider-ipc) for details.
:::

See [Launcher Provider Guide](/v4/development/plugins/launcher-provider/) for details.
...
See [Panel Guide](/v4/development/plugins/panel/) for details.
...
- [Bar Widget Guide](/v4/development/plugins/bar-widget/) - Develop bar widgets
- [Desktop Widget Guide](/v4/development/plugins/desktop-widget/) - Create desktop widgets
- [Desktop Widget Settings Guide](/v4/development/plugins/desktop-widget-settings/) - Create desktop widgets settings
- [Control Center Widget Guide](/v4/development/plugins/control-center-widget/) - Add control center buttons
- [Launcher Provider Guide](/v4/development/plugins/launcher-provider/) - Extend the launcher
- [Panel Guide](/v4/development/plugins/panel/) - Create overlay panels
