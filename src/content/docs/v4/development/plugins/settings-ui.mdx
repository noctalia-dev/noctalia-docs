...
- [Manifest Reference](/v4/development/plugins/manifest/) - Default settings configuration
- [Translations](/v4/development/plugins/translations/) - Translate your settings UI
