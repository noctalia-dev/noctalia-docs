...
The Noctalia APT repository no longer serves v4 packages for Debian-based distributions. v4 is no longer maintained; use the [v5 installation guide](/v5/getting-started/installation/#debian) instead.
:::
