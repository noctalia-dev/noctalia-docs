...
Use [Running the shell](/v4/getting-started/running-the-shell/) for the current guidance.
:::

### Running as a Systemd Service

:::note[IPC Calls]
If your IPC call keybinds don't work, please follow in the FAQ [Why aren't my keybinds working?](/v4/getting-started/faq/#troubleshooting), specifically the fourth cause.
:::
