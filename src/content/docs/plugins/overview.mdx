...
:::tip[Quick Start]
New to plugin development? Jump straight to the [Getting Started guide](./getting-started/) to create your first plugin in minutes!
:::
...
**Learn more:** [Bar Widget Development](./bar-widget/)
...
**Learn more:** [Desktop Widget Development](./desktop-widget/)
...
**Learn more:** [Panel Development](./panel/)
...
**Learn more:** [Settings UI Guide](./settings-ui/) *(coming soon)*
...
For complete API documentation, see the [Plugin API Reference](./api/).
:::
...
1. **[Getting Started](./getting-started/)** - Create your first plugin
   - Set up your development environment
   - Create a basic bar widget
   - Understand the plugin structure

2. **[Manifest Reference](./manifest/)** - Understand plugin configuration
   - Learn all manifest fields
   - Configure entry points
   - Set up default settings

3. **[Bar Widget Development](./bar-widget/)** - Build bar widgets
   - Create interactive widgets
   - Handle user interactions
   - Style with Noctalia's design system

4. **[Panel Development](./panel/)** - Create overlay panels
   - Build full-screen interfaces
   - Handle panel lifecycle
   - Create complex UIs

5. **[Plugin API Reference](./api/)** - Master the API
   - Complete API documentation
   - Service integration
   - Advanced patterns

6. **[IPC Guide](./ipc/)** - Background processing
   - Create IPC handlers
   - Handle external commands
   - Integrate with scripts and keybindings

7. **Additional Topics** *(coming soon)*
   - [Settings UI](./settings-ui/) - Configuration interfaces
...
Ready to start building? Head to the [Getting Started guide](./getting-started/) to create your first plugin in just a few minutes!
