...
- **Check file paths** - Use absolute paths or `~` for the home directory
- **Validate TOML syntax** - Use a TOML validator
- **Check logs** - Run Noctalia from the terminal to see error messages
...
- Visit our [GitHub Issues](https://github.com/noctalia-dev/noctalia/issues)
