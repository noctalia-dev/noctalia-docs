...
For **users** who want to create custom templates for their own applications, see [User Templates](/noctalia-shell/theming/user-templates/).
...
For complete template syntax documentation (colors, formats, filters, blocks), see the [User Templates](/noctalia-shell/theming/user-templates/) guide.
...
- **`outputPath`** - Destination path (`~` is expanded to the home directory)
