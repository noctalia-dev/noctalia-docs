...
Control center widgets are button components that appear in the Control Center panel. They provide quick access to plugin functionality directly from the shortcut area.
...
- [Bar Widget](/noctalia-shell/development/plugins/bar-widget/) - Widgets for the top/bottom bar
- [Panel](/noctalia-shell/development/plugins/panel/) - Create full overlay panels
