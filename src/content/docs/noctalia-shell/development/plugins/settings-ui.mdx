...
- [Manifest Reference](/noctalia-shell/development/plugins/manifest/) - Default settings configuration
- [Translations](/noctalia-shell/development/plugins/translations/) - Translate your settings UI
