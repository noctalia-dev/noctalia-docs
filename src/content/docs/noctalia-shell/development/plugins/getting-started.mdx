...
- [Add a Panel](/noctalia-shell/development/plugins/panel/) - Create an overlay panel
- [Bar Widget Development](/noctalia-shell/development/plugins/bar-widget/) - Advanced bar widget features
- [Plugin API Reference](/noctalia-shell/development/plugins/api/) - Complete API documentation
- [Manifest Reference](/noctalia-shell/development/plugins/manifest/) - Full manifest documentation

- [IPC Guide](/noctalia-shell/development/plugins/ipc/) - Respond to external commands
- [Settings UI](/noctalia-shell/development/plugins/settings-ui/) - Let users configure your plugin
- [Translations](/noctalia-shell/development/plugins/translations/) - Support multiple languages
...
5. **Translations preserve state** - Translation reloads don't reset the plugin state
...
**Widget doesn't show in the bar:**
...
- [Manifest Reference](/noctalia-shell/development/plugins/manifest/) - Complete manifest documentation
- [Bar Widgets](/noctalia-shell/development/plugins/bar-widget/) - Advanced bar widget features
