...
**Returns**: `true` if the panel opened successfully, `false` otherwise
...
**Returns**: `true` if the panel closed successfully, `false` otherwise
...
**Returns**: Translated string, or `## key ##` if translation is not found
...
:::tip
This is the preferred way to get a screen reference in IPC handlers, as it automatically selects the appropriate screen based on the cursor position.
:::
...
// Check if a key event matches a configured keybind action
...
// Convert a key event to a keybind string (e.g. "Ctrl+A", "Shift+F5")
var keyStr = Keybinds.getKeybindString(event);

// Check for keybind conflicts (returns conflicting action name or null)
var conflict = Keybinds.getKeybindConflict(keyStr, "general.keybinds.keyEscape", Settings.data);
```

Common action names for `checkKey` include `"up"`, `"down"`, `"left"`, `"right"`, `"enter"`, and `"escape"`. More keybinds may be available - check [`Settings.qml`](https://github.com/noctalia-dev/noctalia/blob/main/Commons/Settings.qml) under `general.keybinds` for the full list.

:::tip
Use `Keybinds` instead of hardcoding `Qt.Key_*` checks. This ensures your plugin respects the user's custom keybind configuration.
:::
...
- [Bar Widget](/noctalia-shell/development/plugins/bar-widget/) - Bar widget development
- [Desktop Widget](/noctalia-shell/development/plugins/desktop-widget/) - Desktop widget development
- [Control Center Widget](/noctalia-shell/development/plugins/control-center-widget/) - Control center widget development
- [Launcher Provider](/noctalia-shell/development/plugins/launcher-provider/) - Launcher provider development
- [Panel](/noctalia-shell/development/plugins/panel/) - Panel development
- [Settings UI](/noctalia-shell/development/plugins/settings-ui/) - Settings UI development
- [Translations](/noctalia-shell/development/plugins/translations/) - i18n guide
- [Manifest Reference](/noctalia-shell/development/plugins/manifest/) - Plugin configuration
- [Plugin Overview](/noctalia-shell/development/plugins/overview/) - Plugin system overview
