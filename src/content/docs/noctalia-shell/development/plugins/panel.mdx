...
:::tip
Multiply by `Style.uiScaleRatio` to respect the user's UI scaling preferences.
:::
...
7. **Test responsiveness**: Ensure the panel works at different sizes
8. **Clean up**: Properly close panels after actions are complete
...
- [Getting Started](/noctalia-shell/development/plugins/getting-started/) - Plugin development basics
