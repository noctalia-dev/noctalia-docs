...
### `section`
The bar section of this widget is in: `"left"`, `"center"`, or `"right"`.
...
### `sectionWidgetIndex`
The zero-based index of this widget is within its bar section. Used to access per-instance settings and to build unique identifiers for service registration.
...
### `sectionWidgetsCount`
The total number of widgets in this widget's bar section.
...
6. **Respect dark mode**: Use `Color.m*` colors that adapt to the theme
