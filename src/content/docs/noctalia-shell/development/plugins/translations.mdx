...
- [Plugin API](/noctalia-shell/development/plugins/api/) - Translation API reference
- [Settings UI](/noctalia-shell/development/plugins/settings-ui/) - Translate your settings interface
