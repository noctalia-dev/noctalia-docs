...
See [IPC Guide](/noctalia-shell/development/plugins/ipc/) for details.
...
See [Bar Widget Guide](/noctalia-shell/development/plugins/bar-widget/) for details.
...
See [Desktop Widget Guide](/noctalia-shell/development/plugins/desktop-widget/) for details.
...
See [Desktop Widget Guide](/noctalia-shell/development/plugins/desktop-widget-settings/) for details.
...
See [Control Center Widget Guide](/noctalia-shell/development/plugins/control-center-widget/) for details.
...
:::tip
When providing a launcher provider, set `commandPrefix` in `metadata` to define the `>prefix` command. This is also used by `pluginApi.toggleLauncher()` for IPC integration. See [IPC Guide](/noctalia-shell/development/plugins/ipc/#launcher-provider-ipc) for details.
:::

See [Launcher Provider Guide](/noctalia-shell/development/plugins/launcher-provider/) for details.
...
See [Panel Guide](/noctalia-shell/development/plugins/panel/) for details.
...
- **Purpose**:
 - Provide initial values when the plugin is first enabled
 - Serve as fallback when the settings file doesn't exist
...
- [Getting Started](/noctalia-shell/development/plugins/getting-started/) - Create your first plugin
- [Bar Widget Guide](/noctalia-shell/development/plugins/bar-widget/) - Develop bar widgets
- [Desktop Widget Guide](/noctalia-shell/development/plugins/desktop-widget/) - Create desktop widgets
- [Desktop Widget Settings Guide](/noctalia-shell/development/plugins/desktop-widget-settings/) - Create desktop widgets settings
- [Control Center Widget Guide](/noctalia-shell/development/plugins/control-center-widget/) - Add control center buttons
- [Launcher Provider Guide](/noctalia-shell/development/plugins/launcher-provider/) - Extend the launcher
- [Panel Guide](/noctalia-shell/development/plugins/panel/) - Create overlay panels
- [Plugin API](/noctalia-shell/development/plugins/api/) - Full API reference
