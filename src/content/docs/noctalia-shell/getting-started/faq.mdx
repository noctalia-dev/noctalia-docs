...
Noctalia is officially packaged for Arch, NixOS, Gentoo, Fedora, Debian (including Ubuntu and PikaOS), openSUSE, and Void Linux. See the [Installation guide](/noctalia-shell/getting-started/installation/) for details.
