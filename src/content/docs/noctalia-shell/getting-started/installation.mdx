...
The Noctalia team maintains only the **Arch Linux/AUR packages** and the **manual installation method**. Packages shipped in a distribution's official repositories are built and reviewed under that distribution's own packaging process.
...
Noctalia is available in the following distributions:
...
Please replace it with your AUR helper of choice.
