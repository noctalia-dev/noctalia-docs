...
- [Arch Linux](#arch)
- [NixOS](/noctalia-shell/getting-started/nixos/)
- [Gentoo](#gentoo)
- [Fedora](#fedora)
...
Manual installation has **no easy upgrade path**. You will need to manually download and replace files for each update. We strongly recommend using a package manager ([Arch](#arch), [NixOS](/noctalia-shell/getting-started/nixos/), [Gentoo](#gentoo), [Fedora](#fedora)) whenever possible.
:::
...
- Check our [FAQ](/noctalia-shell/getting-started/faq/) for common problems
