...
Use [Running the shell](/noctalia-shell/getting-started/running-the-shell/) for the current guidance.
:::

### Running as a Systemd Service

:::note[IPC Calls]
If your IPC call keybinds don't work, please follow in the FAQ [Why aren't my keybinds working?](/noctalia-shell/getting-started/faq/#troubleshooting), specifically the fourth cause.
:::
