...
- **Getting started**
  - **[Installation](/docs/getting-started/)** — Install Noctalia on your system
  - **[Keybinds](/docs/getting-started/keybinds/)** — IPC commands and example bindings
  - **[FAQ](/docs/getting-started/faq/)** — Common questions and troubleshooting
