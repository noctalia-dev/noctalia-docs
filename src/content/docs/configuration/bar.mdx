...
Displays time, date or other time related information of your choosing, with a calender upon left click.
...
Adds a icon-button to open the ControlCenter menu.
...
| icon             | `"noctalia"`          | String of icon name | Choose a icon by name.                              |
...
| Settings        | Default   | Options                        | Description                                                 |
|-----------------|-----------|--------------------------------|-------------------------------------------------------------|
| icon            | `"heart"` | String of icon name            | Choose a icon to by name.                                   |
...
| middleClickExec | `""`      | String of command              | Command to execute when the button is right-clicked.        |
