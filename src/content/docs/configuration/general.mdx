...
These are mostly the settings found in the ***User interface*** tap in the settings window.
...
These are mostly the settings found in the ***General*** tap in the settings window.
