...
We generate a full 48-color Material Design 3 palette with color roles like `primary`, `secondary`, `tertiary`, `surface`, `error`, and their variants.

See the complete list of [Available Colors](/development/templates/#available-colors) in the template development guide.
