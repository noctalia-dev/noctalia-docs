...
- [Add a Panel](./panel/) - Create an overlay panel
- [Bar Widget Development](./bar-widget/) - Advanced bar widget features
- [Plugin API Reference](./api/) - Complete API documentation
- [Manifest Reference](./manifest/) - Full manifest documentation

- [IPC Guide](./ipc/) - Respond to external commands
- [Settings UI](./settings-ui/) - Let users configure your plugin
- [Translations](./translations/) - Support multiple languages
...
- [Bar Widgets](./bar-widget/) - Advanced bar widget features
- [Plugin API](./api/) - Full API reference
