...
- [Bar Widget Development](./bar-widget/) - Create bar widgets
- [Desktop Widget Development](./desktop-widget/) - Create desktop widgets
- [Plugin API](./api/) - Full API reference
- [Getting Started](./getting-started/) - Plugin development basics
