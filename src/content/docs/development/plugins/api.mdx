...
**Signature**:
```qml
function togglePanel(screen: ShellScreen): bool
```
...
:::tip
`togglePanel` is commonly used in bar widgets and control center widgets to open/close the plugin's panel with a single click.
:::
