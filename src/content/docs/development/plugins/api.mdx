...
- [Bar Widget](./bar-widget/) - Bar widget development
- [Desktop Widget](./desktop-widget/) - Desktop widget development
- [Panel](./panel/) - Panel development
- [Settings UI](./settings-ui/) - Settings UI development
- [Translations](./translations/) - i18n guide
- [Manifest Reference](./manifest/) - Plugin configuration
- [Plugin Overview](./overview/) - Plugin system overview
