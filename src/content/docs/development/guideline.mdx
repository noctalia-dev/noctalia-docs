...
│   ├── Desktop Widgets/        # Desktop widgets panel
...
[lefthook](https://github.com/evilmartians/lefthook#install) is used to format QML files. After cloning the repo, install `lefthook` and run `lefthook install` to install the pre-commit hook.
