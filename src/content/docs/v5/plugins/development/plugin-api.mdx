...
| `10` | Unreleased | The `keyboard_focus` panel entry option. |
| `11` | Unreleased | The `persistent` panel entry option. |

Noctalia currently supports plugin API levels 3 through 11. A plugin declaring an older or newer level is rejected.
