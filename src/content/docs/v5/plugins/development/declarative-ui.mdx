...
Desktop widgets and panels do not patch a fixed control. They describe their UI as a retained `ui.*` tree; Noctalia
diffs each render against the previous tree and updates native controls in place.
