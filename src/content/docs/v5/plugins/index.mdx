...
the plugin requires, independent of both the plugin's version and Noctalia's release version. Noctalia v5 exposes
plugin API 7. Plugins outside the API range supported by the running shell are shown but badged
