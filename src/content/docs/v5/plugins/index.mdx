...
the plugin requires, independent of both the plugin's version and Noctalia's release version. Noctalia v5 beta3 exposes
plugin API 3. Plugins outside the API range supported by the running shell are shown but badged
