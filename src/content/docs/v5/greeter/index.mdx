...
With Noctalia v5 and the greeter both installed, open **Settings → Shell → Security → Noctalia Greeter → Sync Now**. Noctalia copies your wallpaper and palette to the greeter (you will be prompted for admin access via polkit).
