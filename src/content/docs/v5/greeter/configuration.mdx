...
Coordinates are logical pixels (same space your compositor uses). Monitors to the left of the origin can use negative X values. Outputs not listed are still enabled but placed to the right of the configured layout.
