---
title: Configuration
description: greeter.conf settings for sessions, color scheme, monitors, UI scale, cursor theme, and keyboard layout.
sidebar:
  order: 1
---
...
| `keyboard_layout` | XKB layout code(s), e.g. `cz`, `us`, `de,cz` (comma-separated for multiple layouts; see [Keyboard layout](#keyboard-layout)) |
