---
title: Shell
description: IPC commands for shell status, config reload, settings, window switcher, and session actions.
sidebar:
  order: 1
---
...
These commands control shell state, settings windows, the window switcher, and session actions.
