...
description: IPC commands for volume, microphone, brightness, night light, and idle inhibitor.
---
...
| Action | Command | Description |
|--------|---------|-------------|
| Enable inhibitor | `noctalia msg idle-inhibitor-enable` | Prevent idle actions while enabled. |
| Disable inhibitor | `noctalia msg idle-inhibitor-disable` | Allow idle actions again. |
| Toggle inhibitor | `noctalia msg idle-inhibitor-toggle` | Switch idle inhibitor on or off. |
