...
| `noctalia.processMatches(token, ...)` | `boolean` | Check cached process command lines for one containing all tokens. Use this for lightweight process-state polling. |
