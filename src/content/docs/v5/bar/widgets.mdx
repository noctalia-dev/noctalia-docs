...
| `ram_used` | `4.2GiB` | RAM used (binary, auto-scaled) |
| `ram_pct` | `26%` | RAM used % |
| `swap_pct` | `12%` | Swap used % |
| `disk_pct` | `45%` | Disk used % for `path` |
| `net_rx` | `1.2MB/s` | Network download speed (decimal, auto-scaled) |
| `net_tx` | `256kB/s` | Network upload speed (decimal, auto-scaled) |
