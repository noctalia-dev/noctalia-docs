...
| `custom_image` | string | `""` | Path to a custom image displayed instead of the glyph. Leave empty to use the glyph. When set, the image follows global `[shell.app_icon_colorize]` (see [Shell → App icon colorization](/v5/shell/#app-icon-colorization)) |
