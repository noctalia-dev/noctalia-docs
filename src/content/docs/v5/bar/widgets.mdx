...
| `custom_image` | string | `""` | Path to a custom image displayed instead of the glyph. Leave empty to use the glyph. When set, the image is tinted with the widget **Color** setting (same as the glyph fallback) |
