...
Both commands use the global `[shell.screenshot]` output policy. The canonical command list is also under [Keybinds & IPC → Shell & UI → Screenshots](/v5/ipc/shell-and-ui/#screenshots).
