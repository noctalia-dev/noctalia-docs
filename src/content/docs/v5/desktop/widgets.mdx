...
- State file: `$NOCTALIA_STATE_HOME/noctalia/desktop_widgets.toml`, `$XDG_STATE_HOME/noctalia/desktop_widgets.toml`, or `~/.local/state/noctalia/desktop_widgets.toml`
