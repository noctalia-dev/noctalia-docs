...
Starring a wallpaper in **Browse** bookmarks the path only. Clicking a favorite applies the wallpaper together with its stored `theme_mode` and optional `palette_source` settings.
