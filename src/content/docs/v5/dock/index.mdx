...
```sh
noctalia msg dock-show       # re-display all instances
noctalia msg dock-hide       # close all instances until next reload
noctalia msg dock-toggle     # toggle dock visibility
noctalia msg dock-reload     # reload dock configuration
```
