...
The key used to sign the packages will be updated each year. To avoid needing to manually reinstall it (repeating Step 1), install the key package so that it will automatically update.
```bash
