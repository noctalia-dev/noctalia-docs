...
Noctalia is avaliable through a custom repository (Experimental).
...
:::note
This is a unofficial repository (community maintained) and not supported at all by the AerynOS team
:::
---
