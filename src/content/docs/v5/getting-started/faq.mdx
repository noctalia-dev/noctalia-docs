...
<FaqItem question="What compositors are supported?">

Noctalia v5 targets Wayland compositors. Niri and Hyprland have documented setup pages because they need compositor-specific configuration for the best experience.

- [Niri setup](/v5/getting-started/compositor-settings/niri/)
- [Hyprland setup](/v5/getting-started/compositor-settings/hyprland/)

Other Wayland compositors may work when they support the protocols Noctalia needs, but compositor-specific features can be unavailable. For example, compositor blur depends on blur/background-effect protocol support, and Night Light depends on gamma-control support.
...
Use your compositor's autostart mechanism. The [Running Noctalia](/v5/getting-started/running-the-shell/) page has examples for Niri and Hyprland Lua config.
