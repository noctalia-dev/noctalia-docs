...
Adjust the blur parameters above alongside Noctalia's transparency settings (bar background opacity, panel card transparency, translucent widgets) to achieve your desired look.
:::
