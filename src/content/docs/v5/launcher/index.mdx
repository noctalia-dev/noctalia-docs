...
- **Currency rates**: Exchange rates are cached locally and refreshed in the background. Refresh is
  skipped when `[shell].offline_mode` is enabled, in which case the last cached rates are used.
