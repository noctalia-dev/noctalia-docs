...
Settings role pickers expose these role names first. Template files access the same colors through the [Template Reference](/v5/theming/templates/#palette-colors).
