...
**Supported actions:** `validate`, `cancel`, `left`, `right`, `up`, `down`, `tab_next`, `tab_previous`, `delete`, `delete_no_confirm`
...
| `delete` | Delete the selected item (for example, a clipboard history entry). |
| `delete_no_confirm` | Delete the selected item without confirmation. |
