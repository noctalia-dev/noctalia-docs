...
outputs until one reconnects. `background_opacity` sets popup background opacity, and `offset_x` / `offset_y` are the
...
|-----|------|---------|-------------|
| `auto_sync` | `bool` | `false` | Automatically sync the greeter whenever wallpaper, colors, or theme mode change. |
