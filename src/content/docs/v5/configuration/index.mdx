...
- **Noctalia's** - `~/.local/state/noctalia/` (everything the app writes or fetches: GUI overrides, UI state, plugin
  repo caches, exported plugin files, downloaded catalogs) - app-managed and regenerable, so it's always safe to delete.
