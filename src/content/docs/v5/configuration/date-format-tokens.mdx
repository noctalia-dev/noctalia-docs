...
Noctalia date and time settings render the current local time. Clock widgets use this format today, and other date-format settings should use the same token set when they need user-configurable date or time output.
