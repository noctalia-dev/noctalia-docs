...
- [System Controls](/v5/ipc/system-controls/) for Wi-Fi, Bluetooth, night light, audio, caffeine, and power profile
- [Shell & UI → Notifications](/v5/ipc/shell-and-ui/#notifications) for DND
- [Shell & UI → Media](/v5/ipc/shell-and-ui/#media) for media controls
- [Shell & UI → Theme](/v5/ipc/shell-and-ui/#theme) for dark mode
- [Shell & UI → Session](/v5/ipc/shell-and-ui/#session) for session actions
