...
Keyboard navigation uses the global [`[keybinds]`](/v5/configuration/shell/#keybinds) actions: `tab_next` / `tab_previous` switch between the sidebar and the active tab body; arrow keys move within the focused pane.

```toml
[control_center]
sidebar = "compact"
# sidebar_section = "compact"  # optional; defaults to the same as sidebar
# width = 680  # full-sidebar width in pixels (600–1200)
```
