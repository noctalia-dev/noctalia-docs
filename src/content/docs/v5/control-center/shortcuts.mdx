...
- [Media & UI -> Notifications](/v5/ipc/media-and-ui/#notifications) for DND
- [Media & UI -> Media](/v5/ipc/media-and-ui/#media) for media controls
- [Media & UI -> Theme](/v5/ipc/media-and-ui/#theme) for dark mode
- [Shell -> Session](/v5/ipc/shell/#session) for session actions
