...
`screen_recorder` requires the official [`noctalia/screen_recorder` plugin](/v5/plugins/official-plugins/#screen_recorder) to be enabled; without it the shortcut stays disabled.
