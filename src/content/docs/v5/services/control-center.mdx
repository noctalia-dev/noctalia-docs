...
Set `sidebar` under `[control_center]` to choose how Control Center shows its tab navigation.
...
|--------|------|---------|-------------|
| `sidebar` | string | `"compact"` | `"full"` = icons and labels; `"compact"` = icons only; `"none"` = hide the sidebar |
