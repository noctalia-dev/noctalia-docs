...
The Dashboard tab displays a row of shortcut buttons at the bottom. Up to 6 shortcuts are shown.
...
Set `shortcuts = []` under `[control_center]` to hide all Dashboard shortcut buttons.
