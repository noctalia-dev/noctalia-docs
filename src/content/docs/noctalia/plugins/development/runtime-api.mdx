...
| `noctalia.offlineMode()` | bool | Returns `[shell].offline_mode`; plugins must not start network traffic while it is `true`. Requires <PluginApiBadge feature="wallpaper-mask" />. |
