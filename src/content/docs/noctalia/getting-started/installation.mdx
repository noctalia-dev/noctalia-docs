...
The Noctalia team maintains the **Arch Linux/AUR packages** and the **manual installation method**. Official distribution packages are maintained through their distributions' own packaging processes; other repositories listed here are community-maintained. Review a third-party repository before installing from it.
:::
