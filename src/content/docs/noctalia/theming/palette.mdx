...
A palette is the set of colors selected by [`[theme]`](/noctalia/theming/). The theme config chooses the source and mode; the palette provides the actual color values used by bars, panels, widgets, templates, and another theme-aware UI.
