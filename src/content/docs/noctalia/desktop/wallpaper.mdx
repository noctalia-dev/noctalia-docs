...
recursive                    = false    # scan subdirectories when selecting random wallpapers (default: false)
...
theme_mode = "auto"              # optional: auto, light, or dark
