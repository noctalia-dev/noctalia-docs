...
- **Theme is not appearing:** Make sure you've enabled the theme in Discord settings
- **Colors not updating:** Restart your Discord client after changing color schemes
- **Client is not supported:** Check that your Discord client is one of the supported alternatives
