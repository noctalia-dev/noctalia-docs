...
:::warning[Deprecated]
The `screenRecorder` IPC commands have been moved to the [Screen Recorder plugin](/plugins/screen-recorder/). The old IPC syntax is no longer part of the core shell. See the [plugin README](https://github.com/noctalia-dev/noctalia-plugins/blob/main/screen-recorder/README.md) for the current IPC commands.
:::
