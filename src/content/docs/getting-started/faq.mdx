...
Yes! A lot of distros let you install `quickshell` / `quickshell-git`. If you have access to it then there is no problem with using Noctalia! If you don't have access to the quickshell package, you can always try and compile it yourself.
...
### My unoccupied workspaces don't show up on hyprland!

This issue is easily solved by setting the workspaces as persistent in your hyprland config. See [Hyprland Workspace Rules](https://wiki.hypr.land/Configuring/Workspace-Rules/#rules) for more information.
