...
4. **Necessary environment variables not visible to Noctalia at start-up**: This affects Niri Systemd/UWSM/people who do not set the contained environment variables:
   ...
   - If you do not see any of these three you must make them available to Noctalia by adding them to a place where they can be seen in time:
      ...
      - in-config of your compositor for Niri without Systemd/UWSM-less method outlined in [Running the Shell's Step 2 for Systemd](/getting-started/running-the-shell/#2-enable-and-start-the-service)
   ...
   :::
   :::note[Bypass]
   If you don't want to do any of this, while I don't recommend it, you can keep using IPC calls by passing `--any-display` to them.
   :::
