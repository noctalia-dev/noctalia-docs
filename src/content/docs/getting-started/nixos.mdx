  ...
  home-manager.users.drfoobar = {
    ...
    programs.noctalia-shell = {
      ...
      user-templates = ''
        ...
        input = "/path/to/template.tpl"
        output = "/path/to/config.tpl"
      '';
    };
  };
}
...
{ pkgs, inputs, ... }:
{
  home-manager.users.drfoobar = {
    ...
    programs.noctalia-shell = {
      ...
      user-templates = ./path/to/templates.toml;
    };
  };
}
```
  ...
  home-manager.users.drfoobar = {
    ...
    programs.noctalia-shell = {
      ...
      user-templates = {
        ...
        templates = {
          my-app= {
            inputPath = ./templates/my-template.toml;
            outputPath = '${config.xdg.configHome}/my-app/config.toml";
            postHook = "pkill -SIGUSR1 my-app";
          };
        };
      };
    };
