...
Additionally, since `~/.config/noctalia/settings.json` is now a read-only symlink, you can get the latest (or GUI-modified) settings via: Open Settings -> General -> Copy Settings.
