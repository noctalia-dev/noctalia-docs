...
In the section that starts things, after any and all environment variables (where everything should be anyway), add <u>before anything else</u> (Hyprland syntax in this case again, adjust as needed):
```ini
