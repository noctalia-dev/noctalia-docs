...
Noctalia-shell is available through the [home:mantarimay:sway](https://build.opensuse.org/package/show/home%3Amantarimay%3Asway/noctalia-shell) repository on the openSUSE Build Service.

**Step 1**: Add the repository

```bash
sudo zypper addrepo https://download.opensuse.org/repositories/home:mantarimay:sway/standard/home:mantarimay:sway.repo
```
