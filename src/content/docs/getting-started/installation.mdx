...
Noctalia is packaged for [Arch Linux](#arch), [NixOS](/getting-started/nixos/), [Gentoo](#gentoo), [Fedora](#fedora), and [Debian/Ubuntu](#debian), but can also be [installed manually](#manual-install) in other distributions.
