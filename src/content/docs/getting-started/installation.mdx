...
// Allows Notification actions and some more flexible window activation
debug {
    honor-xdg-activation-with-invalid-serial
}
```

Next, choose one of the following options for your wallpaper setup.
...
If you prefer a stationary wallpaper that is visible at all times and that do not scroll when switching workspace, use the following configuration instead of Option 1.
