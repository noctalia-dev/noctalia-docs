...
| Build | Qt6 | Distros |
|-------|-----|---------|
| `trixie` | 6.8 | Debian Trixie, Ubuntu 24.04, Pop!_OS 24.04 |
...
:::note
The APT repository currently only provides `amd64` packages. Debian Bookworm (12) and older are not supported as they ship Qt6 6.4 which is too old.
:::
