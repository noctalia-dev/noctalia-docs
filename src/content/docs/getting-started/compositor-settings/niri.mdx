...
:::caution
As of March 2026, Niri's blur support is still in development and has not been merged yet. You will need a custom build of Niri that includes the `background-effect` feature. If your version of Niri does not support it, adding these rules will result in configuration errors.
:::
