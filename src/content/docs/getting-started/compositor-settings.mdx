...
```
:::note
Option 1 requires "Enable overview wallpaper" to be turned ON in Noctalia's settings on the Wallpaper tab.
:::
...
```
:::note
Option 2 requires "Enable overview wallpaper" to be turned ON in Noctalia's settings on the Wallpaper tab.
:::
