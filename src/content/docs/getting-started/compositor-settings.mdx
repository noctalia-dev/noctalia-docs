...
![Blurred Overview Wallpaper](../../../assets/hyprland-blur/hyprland-blur-1.png)
...
:::note
You can tweak the `ignore_alpha` value and the corresponding Noctalia transparency settings to achieve the look you desire.
:::

![Blurred Overview Wallpaper](../../../assets/hyprland-blur/hyprland-blur-2.png)